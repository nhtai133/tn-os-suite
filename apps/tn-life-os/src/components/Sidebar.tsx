...
export function Sidebar() {
  ...
  return (
    <aside className="w-full md:w-60 shrink-0 bg-zinc-950 border-b md:border-b-0 md:border-r border-zinc-800 flex flex-col md:min-h-screen">
      ...
      <nav className="flex-1 p-3 flex gap-1 overflow-x-auto md:block md:space-y-0.5">
        {nav.map((item) => {
